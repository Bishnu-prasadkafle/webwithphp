...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
        <h2 class="display-4" style="font-weight: bold">About Us</h2>
      </div>
    </div>
    <!-- title end -->
    ...
    <div class="container" style="padding: 30px, 0">
      <hr />
      <h2
        style="text-align: center; text-decoration: underline; color: #4dd517">
        Our Hotel
      </h2>
      <hr />
      <p>
        Paragliding in Pokhara: Soaring Through the Skies of pokhara Pokhara, a
        city nestled in the lap of the Himalayas, is renowned for its
        breathtaking natural beauty and vibrant adventure tourism. Among the
        many activities that draw visitors to this picturesque destination,
        paragliding stands out as one of the most exhilarating and popular
        experiences. Soaring high above the serene Phewa Lake, with the majestic
        Annapurna and Dhaulagiri mountain ranges as a backdrop, paragliding in
        Pokhara offers an unforgettable blend of adrenaline, awe, and serenity.
      </p>
      <center>
        <img
      ...
      <p>
        ...
        situations. When you're launched into the air at high speeds, your body
        releases a surge of adrenaline, triggering the "fight or flight"
        response. This rush can clear your mind, focusing all your attention on
        the present moment and temporarily pushing aside daily stress and
        worries.
      </p>
      <center>
        <img
      ...
      <hr />
      <p>
        A wooden bench is a simple structure, yet it holds the power to create a
        space for introspection and relaxation. When you sit on a wooden bench,
        you are often in a place designed for calm—a park, a riverside, or a
        garden. The natural material of the bench, its connection to the earth,
        and the surrounding greenery all contribute to a sense of grounding and
        peace.
      </p>
      <center>
        <img
